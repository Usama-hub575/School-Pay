...
class RegisterCountryCodePicker extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return RegisterCountryCodePickerState(elements);
  }
}

class RegisterCountryCodePickerState extends State<RegisterCountryCodePicker> {
  CountryCode? selectedItem;
  List<CountryCode> elements = [];
  List<CountryCode> favoriteElements = [];

  RegisterCountryCodePickerState(this.elements);
