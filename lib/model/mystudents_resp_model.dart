...
class School {
  ...
  static School empty(){
    return School(id: -1, name: "-", deletedAt: "-", addedBy: "-", address: "-", description: "-", vat: -1.0, paynestFee: -1, apiKey: "-", merchantId: "-", file: "-", privacy: "-", createdAt: DateTime.now(), updatedAt: DateTime.now());
}
