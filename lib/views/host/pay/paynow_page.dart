                    ...
                    MaterialPageRoute(
                      builder: (BuildContext context) =>
                          MyWebView(
                            ...
                            indx: idx,
                            orderId: Random(1000).nextInt(1000000),
                    ...
                    studentController.myStudentData.update((val) {
                      ...
                      PayNowTransactionDetailModel(
                        student: PayNowTransactionDetailStudent(
                            id: sbrController.bankResponseData.value.student!
                                .id,
                            ...
                            parentEmiratesId: sbrController
                                .bankResponseData.value.student!
                                .parentEmiratesId,
                            parentPhoneNumber: sbrController
                                .bankResponseData.value.student!
                                .parentPhoneNumber,
                            dob: sbrController.bankResponseData.value.student!
                                .dob,
                            ...
                            guardianEmiratesId: sbrController
                                ...
                                .guardianEmiratesId,
                            guardianNationality:
                            sbrController.bankResponseData.value.student!
                                .guardianNationality,
                            guardianReligion: sbrController.bankResponseData
                                .value.student!.guardianReligion,
                            area: sbrController.bankResponseData.value.student!
                                .area,
                            region: sbrController.bankResponseData.value
                                .student!.region,
                            streetAddress: sbrController.bankResponseData.value
                                .student!.streetAddress,
                            email: sbrController.bankResponseData.value.student!
                                .email,
                            phoneNumber: sbrController.bankResponseData.value
                                .student!.phoneNumber,
                            otherNumber: sbrController.bankResponseData.value
                                .student!.otherNumber,
                            profile: sbrController.bankResponseData.value
                                .student!.profile,
                            religion: sbrController.bankResponseData.value
                                .student!.religion,
                            nationality: sbrController.bankResponseData.value
                                .student!.nationality,
                            gender: sbrController.bankResponseData.value
                                .student!.gender,
                            dueDate: sbrController.bankResponseData.value
                                .student!.dueDate,
                            file: sbrController.bankResponseData.value.student!
                                .file,
                            privacy: sbrController.bankResponseData.value
                                .student!.privacy,
                            createdAt: sbrController.bankResponseData.value
                                .student!.createdAt,
                            updatedAt: sbrController.bankResponseData.value
                                .student!.updatedAt),
                        referenceNo:
