      ...
      body: Column(
        children: [
          ...
          Obx(() => controller.isLoading.value == false
              ? Expanded(
                  child: controller.myStudentData.value.status == true
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                if (controller.myStudentData.value
                                  ...
                                  if (index == 0) {
                                    var isSchoolNull = controller.myStudentData
                                        .value.students![index].student!.school;
                                    return Padding(
