...
class _MyWebViewState extends State<MyWebView> {
  final SetBankResponseController sbrController = Get.find<SetBankResponseController>();
  ...
  void initState() {
    ...
    paymentGateWay = "https://discoveritech.com/schoolpay-transactions/PaymentInitiator.php?amount=${widget.amount}";
  }
    ...
    return Scaffold(
        ...
        WebView(
          ...
          onPageStarted: (url) {
            ...
            if(url == "https://discoveritech.com/BorderPay_Payment_Api/ReceiveResult.php"){
          ...
          onPageFinished: (url) async {
            ...
            if (!isCodeReceived && url.contains('https://discoveritech.com/schoolpay-transactions/cdb_recieve.php?')) {
              print('got it');
              isCodeReceived = true;
              var CBDReferenceNo = getResponse(Uri.parse(url).queryParameters['string'] ?? '');
